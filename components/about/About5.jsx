...
function About5() {
  ...
  return (
    <>
      <div className="about-section5 position-relative overflow-hidden pt-120">
        <img
          src="assets/images/bg/water-mark3.png"
          alt="image"
          className="about5-bg"
        />
        <img
          src="assets/images/icons/snake-vector.svg"
          alt="image"
          className="snake-vector1"
        />
        <img
          src="assets/images/icons/snake-vector.svg"
          alt="image"
          className="snake-vector2"
        />
        <div className="container">
          <div className="row justify-content-center align-items-center g-4">
            <div
              ...
              data-wow-delay=".2s"
            >
              <div className="about5-image text-center">
                <img
                  src="assets/images/bg/about51.png"
                  className="about51"
                  alt="image"
                />
                <img
                  src="assets/images/bg/about52.png"
                  className="about52"
                  alt="image"
                />
                <div className="about5-video">
            ...
            <div className="col-xl-5 col-lg-6 d-flex justify-content-lg-start justify-content-center">
              <div
                className="about3-content style-3 wow fadeInRight"
                data-wow-duration="1.5s"
                data-wow-delay=".2s"
              >
                <h3>We create some things, Design for your success future.</h3>
                <h4>
                  We’re committed to delivering the best digital marketing for
                  your businesses.
                </h4>
                <p className="para">
                  Lorem Ipsum is simply dumm of free available in market the way
                  printing and typesetting industry has been the industrys
                ...
                <ul className="feature-list">
                  ...
                  <li>
                    ...
                    the way printing. been the industry standard.
                  </li>
                </ul>
                <div className="about-footer d-flex jusify-content-start align-items-center flex-wrap gap-4">
                  ...
                  <div className="experience d-flex flex-row align-items-center">
                    ...
                    <h4 className="mb-0">10+ Years Experience</h4>
                  </div>
                </div>
              </div>
            </div>
